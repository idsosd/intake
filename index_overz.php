...
$sql = "SELECT * FROM gesprekken WHERE gespr_opl=:oplcode AND gespr_cohort=:coh AND gespr_uitkomst<2 AND gespr_aanmstatus<>3 AND ORDER BY gespr_datum, gespr_achternaam";
