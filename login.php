    ...
    <div class="row">
        ...
        <div class="col-sm">
            ...
            <div class="card" style="width: 18rem; margin-top: 20px">
                <img src="../intake/img/Alfa_College_Logo.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <?php
                    if($error == 1) {
                    ...
                    elseif ($verified == 0) {
                        ...
                        echo "Uw aanmelding is met succes ontvangen; zoek contact met OSD om uw aanmelding definitief te maken!";
                        echo "</div>";
                    }
                    ?>
                    ...
                    <form method="POST" action="app/verwerk_login.php">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="inputEmail" name="inputEmail" placeholder="voorb: naam@provider.com" required>
                        </div>
                        <div class="form-group">
                    ...
                    <a href="meldaan.php">meld je aan als gebruiker</a>
                </div>
            </div>
        </div>
        <div class="col-sm">
